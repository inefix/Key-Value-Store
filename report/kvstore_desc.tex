...
Ces scripts s'occupent de lancer des petits scripts qui eux lancent le serveur ou le client. Enfin, les petits scripts envoient des entrés d'utilisateur automatiquement aux clients ce qui enverra des requêtes au serveur. 
\begin{lstlisting}
